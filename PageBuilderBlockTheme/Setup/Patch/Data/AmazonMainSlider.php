...
class AmazonMainSlider implements DataPatchInterface
{
    ...
    public function apply()
    {
        ...
        $block_data_head = [
            'title' => 'Amazon Slider Main',
            'identifier' => 'amazon-slider-main',
            'is_active' => 1,
            'content' => file_get_contents(__DIR__ . '/html/amazon_slider_main.html'),
        ];
